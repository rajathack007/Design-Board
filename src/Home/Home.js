...
class Home extends Component {
    render(){
        return(
            <div className="body">
                 <div className="homenavbar" > <Link to="/Home"  class="active" style={{color:"white",textDecoration:"none",display:"inline-flex"}}> ETU LOGO</Link>
         ...
         <Link to="/PrivacyPolicy" style={{marginLeft:"2%",fontSize:20,paddingTop:".75%",color:"white",textDecoration:"none"}}>Privacy Policy</Link>
                   ...
                   <Link to="/sign-in" style={{marginLeft:"40%",color:"white",textDecoration:"none"}}> <a style={{fontSize:20,paddingTop:".75%"}}>Login</a></Link></div> 
